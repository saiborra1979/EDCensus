...
# # Save for later
# dat_prec_dtrain.to_csv(os.path.join(dir_output, 'dat_dtrain.csv'),index=False)
# dat_prec_nval.to_csv(os.path.join(dir_output, 'dat_nval.csv'),index=False)
# dat_prec_rtrain.to_csv(os.path.join(dir_output, 'dat_rtrain.csv'),index=False)


####################
# --- (5) PLOT --- #

# (i.a) Optimal training days
...
# (i.c) Optimal retraining frequency
